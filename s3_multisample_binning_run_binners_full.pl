...
print OU2 "echo -e \">faker_best_mid\\n\$(printf 'GG%.0s' {1..66666})\" > ./faker.fa \n";
print OU2 "mkdir -p ../concoct_$min_length/bins/\n";
print OU2 "cp ./faker.fa ../concoct_$min_length/bins/\n";
print OU2 "mkdir -p ../metabat2_1500/bins/\n";
print OU2 "cp ./faker.fa ../metabat2_1500/bins/\n";
...
print OU2 "cp ./faker.fa round_1/metawrap_50_10_bins/ \n";
print OU2 "mkdir -p ../SemiBin2_$min_length/output_bins/ \n";
print OU2 "cp ./faker.fa ../SemiBin2_$min_length/output_bins/ \n";
print OU2 "mkdir -p ../COMEBin_$min_length/comebin_res/comebin_res_bins/ \n";
print OU2 "cp ./faker.fa ../COMEBin_$min_length/comebin_res/comebin_res_bins/ \n";
...
print OU2 "cp ./faker.fa round_2/metawrap_50_10_bins/ \n";
print OU2 "mkdir -p ../MetaBinner_$min_length/bins/ \n";
print OU2 "cp ./faker.fa ../MetaBinner_$min_length/bins/ \n";
