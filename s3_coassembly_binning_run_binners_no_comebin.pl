...
print OU2 "metawrap bin_refinement -o round_2_final -t $cpu -c 50 -A round_1/r1_metawrap_50_10_bins/ -B ../SemiBin2_$min_length/output_bins/ -C ../MetaBinner_$min_length/bins/\n";
print OU2 "cd ../ \n";
